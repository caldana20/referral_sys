...
docker buildx build --no-cache --platform  linux/amd64 \
  -t us-west1-docker.pkg.dev/refoza/refoza/backend:v49 \
  ./server --push
...
docker buildx build --no-cache   --platform linux/amd64 \
  ...
  -t us-west1-docker.pkg.dev/refoza/refoza/frontend:v49 \
  ./next-app --push


docker buildx imagetools inspect us-west1-docker.pkg.dev/refoza/refoza/backend:v49
docker buildx imagetools inspect us-west1-docker.pkg.dev/refoza/refoza/frontend:v49
```
...
Option 2 (quick):
```
kubectl -n refoza set image deployment/refoza-backend backend=us-west1-docker.pkg.dev/refoza/refoza/backend:v49
kubectl -n refoza set image deployment/refoza-frontend frontend=us-west1-docker.pkg.dev/refoza/refoza/frontend:v49
```
